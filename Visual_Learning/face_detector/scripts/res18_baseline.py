...
class Res18Baseline(nn.Module):
    def __init__(self, args):
        ...
        res18 = models.resnet18(pretrained=True) # This was false it is now set to True
        # with torch.no_grad():
        ...
        # This creates another layer. Sequential concatonates two layers
        ...
        # This is a concationation of another 2 layers
        self.segmentation_conv = nn.Sequential(
            nn.Conv2d(128, 64, kernel_size=3, stride=1, padding=1),   #stride and padding = 1 means overall size stays the same
            nn.ReLU(),
